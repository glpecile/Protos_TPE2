...
COMMON =  ./src/args.c ./src/buffer.c ./src/hello.c ./src/hello_events.c ./src/logger.c ./src/netutils.c ./src/parser.c ./src/parser_utils.c ./src/request.c ./src/selector.c ./src/socks_handler.c ./src/socks_nio.c ./src/stm.c
main:
